...
public class Vision {
	...
	public void doVisionCalc() throws NIVisionException, AxisCameraException {
		...
		try {
			...
			//image = new RGBImage("/vision/RGBtestimage.png");	    // get image from camera
			BinaryImage thresholdImage = image.thresholdHSV(110, 180, 90, 255, 20, 255);   // keep only green objects
			//thresholdImage.write("/threshold.bmp");
			BinaryImage convexHullImage = thresholdImage.convexHull(false);//fill in partial and full rectangles
			//convexHullImage.write("/convexHullImage.bmp");
			BinaryImage filteredImage = convexHullImage.particleFilter(cc);           // filter out small particles, the current error is in this line of code
			 ...
			 */
			//filteredImage.write("C:\\Users\\johnw_000\\Desktop\\Robotics\\image.png");
			filteredImage.free();
			thresholdImage.free();
			image.free();

                //ParticleAnalysisReport distanceReport = filteredImage.getParticleAnalysisReport(target.verticalIndex);
			//return computeDistance(filteredImage, distanceReport, target.verticalIndex);
